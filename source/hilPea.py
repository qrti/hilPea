...
name = "hilbert"
# hilbert2d(2, 0, 0, 0, 0)
hilbert3d(4, 0, 0, 0, L(1, 0, 0), L(0, 1, 0), L(0, 0, 1))
...
# list variations peano 2d
#
# dir = { '+a': L(1, 0), '+b': L(0, 1), '-a': -L(1, 0), '-b': -L(0, 1) }
# x = -3 * 4
# 
# for i in sorted(dir):    
#     for j in sorted(dir):
...
# 
#             name = "{}{}".format(i, j)
#             peano2d(3, 0, 0, dir[i], dir[j])
# 
#             markStart()
#             createMeshFromData(name, (x, 0, 0))
#             x += 3

# list variations peano 3d
#
